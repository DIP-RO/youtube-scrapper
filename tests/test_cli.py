"""Tests for the CLI in yt_network_scraper.cli."""
...
from yt_network_scraper.cli import build_parser, main
from yt_network_scraper.exceptions import InvalidVideoURLError, ScraperError
...
class TestMain:
    @patch("yt_network_scraper.cli.YouTubeScraper")
